...
exports.properties = [
    ...
    },
    {
        displayName: 'Status',
        name: 'status',
        description: 'Return only runs with the provided status. See the dropdown options or the Apify documentation https://docs.apify.com/platform/actors/running/runs-and-builds#lifecycle.',
        default: 'SUCCEEDED',
        type: 'options',
        options: [
